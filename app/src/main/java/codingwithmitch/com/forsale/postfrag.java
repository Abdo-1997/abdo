 ...
 */
public class postfrag extends Fragment implements dialogSelectPh.OnPhotoSeletedListener {
    ...
    @Override
    public void getimagebitmab(Bitmap bitmap) {Log.d(TAG, "getImageBitmap: setting the image to imageview");
    ...
    private void init(){
        mPostImage.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                dialogSelectPh dialog = new dialogSelectPh();
                dialog.show(getFragmentManager(), getString(R.string.dia_pho));
                dialog.setTargetFragment(postfrag.this, 1);
            }
        });
